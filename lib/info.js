...
exports.getBasicInfo = async(id, options) => {
  ...
  if (!options.poToken) {
    ...
    options.poToken = (await generator.generate()).poToken
    options.visitorData = (await generator.generate()).visitorData;
}
...
const fetchIosJsonPlayer = async(videoId, options) => {
  const payload = {
    ...
    serviceIntegrityDimensions: (await generator.generate()).poToken,
    contentCheckOk: true,
    racyCheckOk: true,
    context: {
      client: {
